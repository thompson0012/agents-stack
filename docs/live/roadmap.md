...
| 1 | Align `templates/base/docs/live/` scaffolds to the root standard | Completed |
| 2 | Align `templates/base/docs/reference/` scaffolds to the root standard | Completed |
| 3 | Update `templates/base/AGENTS.md` and root `AGENTS.md` — remove `software-delivery`, align contract | Completed |
| 4 | Cross-surface verification: no overlap, stale references, or contradictions | Active |
