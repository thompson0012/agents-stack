...
- Copy `.harness/<workstream-id>/review.md` and optionally `.harness/<workstream-id>/qa.md` from the canonical templates at `references/templates/.harness/`. Fill placeholders; delete template comment blocks. Do not construct these files from memory.
