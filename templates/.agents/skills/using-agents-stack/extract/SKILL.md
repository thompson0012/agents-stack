...
The orchestrator provides inline digest covering workstream outcome, audit verdict, key findings. Read all workstream artifacts from disk for thorough extraction — thoroughness matters here, not speed.
