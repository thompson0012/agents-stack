...
- current sprint truth: the strongest local artifact such as `.agents-stack/<WORKSTREAM-ID>/review.md`, `handoff.md`, `runtime.md`, or `contract.md`
- current live selectors: `.agents-stack/current-focus.md` and `.agents-stack/tracked-work.json`
