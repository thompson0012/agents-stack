...
|---|---|---|
| **Mapbox GL JS** | Interactive maps, custom styles, markers, 3D terrain | `<script src="https://api.mapbox.com/mapbox-gl-js/v3.12.0/mapbox-gl.js"></script>` |
| **Leaflet** + **OpenStreetMap** | Free (no API key), markers, popups, GeoJSON | `<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>` + CSS: `leaflet@1.9.4/dist/leaflet.css` |
